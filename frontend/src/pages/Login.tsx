          ...
          <div className="bg-gray-900/50 rounded-2xl p-8 ring-1 ring-white/10 max-w-md w-full mx-auto">
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className={`w-full h-12 rounded-full font-medium transition shadow-[inset_0_-2px_0_rgba(255,255,255,0.1)] ${!loading && mobileNumber.length === 10
      ...
      {showOtp && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative z-10 w-full max-w-md bg-gray-900 rounded-xl p-6 ring-1 ring-white/10">
            ...
            <p className="text-sm text-gray-400 mb-6">We sent a 6-digit code to +91{mobileNumber}</p>
